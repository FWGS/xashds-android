...
$JAVA_HOME/bin/javac -d bin/classes -s bin/classes -cp $ANDROID_JAR src/in/celest/xash3d/dedicated/DedicatedActivity.java
$DX --dex --output=bin/classes.dex bin/classes/
/mnt/app/apktool/aapt package -f -M AndroidManifest.xml -S res -I $ANDROID_JAR -F bin/$NAME.apk.unaligned
zip bin/$NAME.apk.unaligned assets/*
$APKBUILDER bin/$NAME.apk -u -f bin/classes.dex -z bin/$NAME.apk.unaligned
